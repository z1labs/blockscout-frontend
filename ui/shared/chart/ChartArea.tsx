...
const ChartArea = ({ id, xScale, yScale, color, data, noAnimation, ...props }: Props) => {
  ...
  const defaultGradient = {
    startColor: useToken('colors', useColorModeValue('brand.100', 'brand.400')),
    stopColor: useToken('colors', transparentize(useColorModeValue('brand.100', 'brand.400'), 0)(theme)),
  };
